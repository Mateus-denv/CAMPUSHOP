...
public record PedidoResponse(
    ...
    public static PedidoResponse fromEntity(Pedido pedido) {
        return new PedidoResponse(
                ...
                pedido.getPrazoEntregaLimite() != null ? pedido.getPrazoEntregaLimite().toString() : null,
                pedido.getDataEntrega() != null ? pedido.getDataEntrega().toString() : null,
                pedido.getDataInvalidacao() != null ? pedido.getDataInvalidacao().toString() : null,
