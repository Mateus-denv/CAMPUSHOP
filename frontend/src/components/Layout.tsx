...
export function Layout({ children }: LayoutProps) {
  ...
  useEffect(() => {
    ...
    return () =>
      window.removeEventListener("campushop-orders-changed", carregarPendentes);
  }, [usuario]);
    ...
    <div className="flex min-h-screen flex-col bg-[radial-gradient(circle_at_top,_#dbeafe_0,_#eff6ff_24%,_#f8fafc_58%,_#ffffff_100%)] text-slate-900">
      <header className="sticky top-0 z-50 border-b border-slate-200/80 bg-white/85 backdrop-blur">
        <div className="mx-auto flex max-w-[1440px] items-center justify-between gap-6 px-4 py-4 sm:px-6 lg:px-8">
          <Link
            to="/home"
            className="flex items-center gap-3 font-black tracking-tight text-slate-900"
          >
            <Logo variant="home" />
          </Link>
        ...
        <div className="mx-auto flex max-w-7xl flex-col gap-6 px-4 py-4 sm:px-6 lg:px-8 lg:py-5">
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-slate-500">
                    Marketplace estudantil para compra, venda e troca no campus.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="grid grid-cols-2 gap-4 sm:grid-cols-4">
              <div>
                ...
                <div className="mt-3 space-y-2 text-sm">
                  <a
                    href="mailto:suporte@campushop.com"
          ...
          <div className="flex flex-col gap-2 border-t border-slate-200 pt-3 text-xs text-slate-400 sm:flex-row sm:items-center sm:justify-between">
            ...
            <div className="flex flex-wrap gap-4">
              ...
              <a href="/termos" className="transition hover:text-slate-600">
                Termos
              </a>
              <a href="/anunciar" className="transition hover:text-slate-600">
                Anunciar
              </a>
              <a
                href="/manual-usuario"
