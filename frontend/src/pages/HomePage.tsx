...
// React Router: navegação SPA sem recarregar página
import { Link } from 'react-router-dom'
// Layout: componente compartilhado de navegação e estrutura
import { Layout } from '@/components/Layout'
// Dados mockados: simulação de dados da API para desenvolvimento
...
// ===== COMPONENTE HOMEPAGE =====
// Página inicial do CampusShop - landing page principal
// Responsável por apresentar: hero section, categorias, produtos em destaque
// Design focado em conversão: gradientes atraentes, CTAs claros, UX mobile-first
// Hofunction HomePage() {
return (
  <Layout>
...
// HomePage é um componente funcional React que retorna JSX
// - Layout: wrapper com navegação e footer consistentes
// - Section Hero: chamada principal com gradiente e CTA
// - Section Categorias: grid responsivo de categorias
// - Section Produtos: cards de produtos em destaque
//
// PADRÕES DE DESIGN UTILIZADOS:
// - Mobile-first: design começa mobile, expande para desktop
// - Glassmorphism: efeitos de transparência e blur
// - Gradientes: cores dinâmicas para atratividade visual
// - Micro-interações: hover effects suaves (translate, shadow)
// - Sistema de cores: slate (neutro), blue (primário), orange (secundário)
//
// RESPONSIVIDADE:
// - Breakpoints: sm (640px), md (768px), lg (1024px)
// - Grid: muda colunas baseado no tamanho da tela
// - Tipografia: escala progressiva (text-4xl → text-6xl)
//
// PERFORMANCE:
// - Componentes funcionais sem estado local desnecessário
// - Dados mockados (em produção: useState + useEffect para API)
// - Lazy loading potencial para imagens de produtos